...
if("TRUE" STREQUAL "TRUE")
  set(openslam_gmapping_SOURCE_PREFIX /root/ari_public_catkin_ws/src/openslam_gmapping)
  set(openslam_gmapping_DEVEL_PREFIX /root/ari_public_catkin_ws/devel/.private/openslam_gmapping)
  ...
  set(openslam_gmapping_INSTALL_PREFIX /root/ari_public_catkin_ws/install)
...
if(NOT "/root/ari_public_catkin_ws/src/openslam_gmapping/include " STREQUAL " ")
  set(openslam_gmapping_INCLUDE_DIRS "")
  set(_include_dirs "/root/ari_public_catkin_ws/src/openslam_gmapping/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'openslam_gmapping' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/ari_public_catkin_ws/src/openslam_gmapping/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /root/ari_public_catkin_ws/devel/.private/openslam_gmapping/lib;/root/ari_public_catkin_ws/devel/lib;/opt/ros/melodic/lib)
