...
(cl:in-package ari_opencv_tutorial-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <valueMatrix>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'valueMatrix)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ari_opencv_tutorial-msg:<valueMatrix> is deprecated: use ari_opencv_tutorial-msg:valueMatrix instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <valueMatrix>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ari_opencv_tutorial-msg:header-val is deprecated.  Use ari_opencv_tutorial-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'value-val :lambda-list '(m))
(cl:defmethod value-val ((m <valueMatrix>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ari_opencv_tutorial-msg:value-val is deprecated.  Use ari_opencv_tutorial-msg:value instead.")
  (value m))

(cl:ensure-generic-function 'tick-val :lambda-list '(m))
(cl:defmethod tick-val ((m <valueMatrix>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ari_opencv_tutorial-msg:tick-val is deprecated.  Use ari_opencv_tutorial-msg:tick instead.")
  (tick m))

(cl:ensure-generic-function 'option-val :lambda-list '(m))
(cl:defmethod option-val ((m <valueMatrix>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ari_opencv_tutorial-msg:option-val is deprecated.  Use ari_opencv_tutorial-msg:option instead.")
  (option m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<valueMatrix>)))
  ...
  "ari_opencv_tutorial/valueMatrix")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'valueMatrix)))
  "Returns string type for a message object of type 'valueMatrix"
  "ari_opencv_tutorial/valueMatrix")
